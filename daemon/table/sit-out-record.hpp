...
#ifndef NFD_DAEMON_TABLE_SIT_OUT_RECORD_HPP
#define NFD_DAEMON_TABLE_SIT_OUT_RECORD_HPP
 ...
 */
class SitOutRecord : public FaceRecord
{
public:
  explicit
  SitOutRecord(Face& face);
...
#endif // NFD_DAEMON_TABLE_SIT_IN_RECORD_HPP
