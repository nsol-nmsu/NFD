...
#ifndef NFD_DAEMON_FW_STATEFUL_FW_STRATEGY_HPP
#define NFD_DAEMON_FW_STATEFUL_FW_STRATEGY_HPP
...
/** \brief Stateful forwarding strategy 1
 *
 ...
 */
class StatefulForwardingStrategy : public Strategy
{
public:
  explicit
  StatefulForwardingStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);
...
#endif // NFD_DAEMON_FW_STATEFUL_FW_STRATEGY_HPP
